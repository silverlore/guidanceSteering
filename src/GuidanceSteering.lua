...
function GuidanceSteering:onMissionLoadFromSavegame(xmlFile)
    ...
    while true do
		...
		track.guidanceData.headlineArcDistance = MathUtil.round(Utils.getNoNil(getXMLFloat(xmlFile, key .. ".guidanceData#headlineArcDistance"), GlobalPositioningSystem.DEFAULT_HEADLINE_ARC_DISTANCE),3)
...
local function _saveTrack(self, id, data)
	...
	track.guidanceData.headlineArcDistance = data.guidanceData.headlineArcDistance
